...
BPM = 180
TEMPO_ACORDE_SEGUNDOS = 60 / BPM * 2 # Um compasso (4 tempos) a 120 BPM = 2.0s
...
ENVELOPE = {
    ...
    "release": 0.4  # Longo - o som decai suavemente ao soltar a nota
}
...
DETUNE_CENTS = 4 # leve desvio (em centésimos de semitom) entre as vozes

# --- Cadeia de Efeitos ---

# VCF - Aplicando no fim do Envelope
FILTRO = {
    "cutoff_freq": 2000, # frequência de corte (8kHz, deixando o som claro)
    "type": "lowpass"    # deixa passar apenas frequências baixas (cortando agudos)
}

# Reverb
REVERB = {
    "mix": 0.6,          # 30% de som com efeito
